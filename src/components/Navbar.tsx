...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    slug: "iptv",
    subcategories: [
      { label: "Live TV", slug: "live-tv" },
      { label: "Movies & Series", slug: "movies-series" },
      { label: "Sports Channels", slug: "sports-channels" },
      { label: "Premium Packages", slug: "premium-packages" },
      { label: "Family Plans", slug: "family-plans" },
    ],
  },
  {
    label: "Gift Cards",
    ...
    subcategories: [
      ...
      { label: "Epic Games", slug: "epic-games" },
    ],
  },
  {
    label: "Subscriptions",
    ...
    subcategories: [
      ...
      { label: "EA Play", slug: "ea-play" },
      { label: "Ubisoft+", slug: "ubisoft-plus" },
      { label: "Nintendo Online", slug: "nintendo-online" },
    ],
  },
  {
    label: "Deals",
